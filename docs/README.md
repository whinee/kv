...
<p align="center">
    <a href="https://github.com/whinee/kv/releases">
        <img alt="GitHub release (latest by date including pre-releases)" src="https://img.shields.io/github/v/release/whinee/kv?include_prereleases&style=flat-square">
    </a>
    <a href="https://github.com/whinee/kv/releases">
        <img alt="GitHub Workflow Status" src="https://img.shields.io/github/workflow/status/whinee/kv/Build?label=Build&style=flat-square">
    </a>
</p>
<p align="center">
...
<h4 align="center">
Cloudflare KV(<b>K</b>ey-<b>V</b>alue) REST(<b>RE</b>presentational <b>S</b>tate <b>T</b>ransfer) API(<b>A</b>pplication <b>P</b>rogramming <b>I</b>nterface) (???)
</h4>

---

Github: [github.com/whinee/kv](https://github.com/whinee/kv)

Website: [whine.is-a.dev/p/w/kv](https://whine.is-a.dev/p/w/kv)
...
- <details>
    <summary>200</summary>
    Key-value pair succesfully modified.
...
- <details>
    ...
    <ul>
        ...
        <li>
            ...
            <ul>
                <li>
                    <pre><code>Invalid username.</code></pre>
                </li>
                <li>
...
- <details>
    <summary>405</summary>
    Only use `POST` method at this endpoint.
    <pre><code>POST method only.</code></pre>
</details>
